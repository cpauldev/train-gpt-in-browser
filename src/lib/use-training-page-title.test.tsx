...
const DEFAULT_TITLE = "Train GPT in Browser | Local Character-Level GPT Trainer";
...
describe("use-training-page-title", () => {
  ...
  it("shows live progress while training is running", () => {
    ...
    expect(document.title).toBe(`Training 42/100 (42%) • English Words • ${DEFAULT_TITLE}`);
  });
  ...
  it("shows a completion title briefly, then restores the default title", () => {
    ...
    expect(document.title).toBe(`Finalizing 100/100 (100%) • English Words • ${DEFAULT_TITLE}`);
