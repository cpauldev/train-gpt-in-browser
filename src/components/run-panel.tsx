import { ArrowUpRight, Brain, Heart, Sparkles, X } from "lucide-react";
...
export function RunPanel({
  ...
  return (
    <div className="relative h-full">
      ...
      <div className={cn("absolute inset-0", activeRun && "pointer-events-none invisible")}>
  ...
  return (
    <Frame className="h-full overflow-hidden lg:min-h-0">
      <FramePanel className="flex flex-1 flex-col overflow-hidden p-0 lg:min-h-0">
        ...
        <div
          className={cn(
            "relative z-10 border-border border-t bg-background",
              ...
              >
                <div className="space-y-2">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-1 text-foreground text-xs underline-offset-4 hover:underline"
                  >
                    View on GitHub
...
function ResultsTable({
  ...
  return (
    <Table aria-label={ariaLabel} className={cn(columnCount > 1 && "table-fixed")}>
      <TableBody className="shadow-none before:hidden *:[tr]:*:[td]:border-0 *:[tr]:*:[td]:bg-transparent *:[tr]:*:[td]:first:border-s-0 *:[tr]:first:*:[td]:border-t-0 *:[tr]:*:[td]:last:border-e-0">
          ...
          <TableRow key={`${ariaLabel}-${row.key}`}>
            {row.cells.map((cell) => (
              <TableCell
                ...
                className={cn(
                  "min-w-0 max-w-0 overflow-hidden py-0",
